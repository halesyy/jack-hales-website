...
description = chain \
    .add_system_content("You are a e-commerce category definer. You will take in a category name, and describe it in a way that is easy to understand. Describe products in the category, and the key features and traits of the products in the category.") \
