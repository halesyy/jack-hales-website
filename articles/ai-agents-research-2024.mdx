...
[Enterprise Knowledge article on sementic layers](https://enterprise-knowledge.com/expert-analysis-how-do-i-get-started-with-a-semantic-layer-using-entity-resolution-for-multiple-source-fusion/) explore cases of "semantic layers", which are in the area of knowledge graphs, unstructured-structured graphs, and how entity resolution (ER) fits into this. It defines the use-case in some real-world examples fitting:

1. Improving data quality and inconsistency
2. Duplicate and redundant records
3. Interoperability from a 360-view
...
I've expanded some of my thinking on this topic in [Large Language Model Tool Design: Functional or OOP?](https://jackhales.com/article/large-language-model-tool-design-functional-or-oop) on this website.