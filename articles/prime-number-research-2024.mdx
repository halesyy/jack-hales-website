...
I'm sure this is just bamboozling once again, but I feel as if it describes the slow tilt-up with any attempt at fitting the prime curve. We see a semi-related, semi-correlated inverse relationship, though it slightly deviates over-time. This makes me want to investigate the delta of the difference between Y-A chart to see what manifests there:
